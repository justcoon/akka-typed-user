...
trait UserService extends EntityService[Future, UserEntity.UserId, User, UserAggregate.UserCommand]

object UserService {

  def apply(departmentService: DepartmentService, addressValidationService: AddressValidationService[Future])(implicit
